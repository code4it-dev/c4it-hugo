...
We've also seen that you can use the OpenAPI file to [navigate the APIs via the CLI with HttpRepl](https://www.code4it.dev/blog/httprepl "Use HttpRepl to navigate APIs") as if they were folders within a file system. It's interesting for discovering the possible operations, but not really that useful for real integration with a project.
